...
window.onload = function() {
    ...
    // Determine browser support for indexedDb
    try {window.indexedDB = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || 
        window.msIndexedDB;
    } catch(error) {
        console.log(error);
    }
    try {window.IDBTransaction = window.IDBTransaction || window.webkitIDBTransaction || 
    ...
    DBOpenRequest.onsuccess = (e) => {
        ...
        // if database is not initiated or if upgrade is needed
