 ...
 export default class QuakesView {
    ...
    renderQuake(quake, element) {
      ...
      element.parentElement.parentElement.innerHTML = `<h1>${quakeProperties.title}</h1>
      <div>
          ...
          <a class="btn" href="${quakeProperties.url}">More Info</a>
      </div><button class="back">Back</button>`;
    }
  }
